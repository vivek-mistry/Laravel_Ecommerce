    ...
    <div class="container">
        <div class="row my-5 py-lg-5">
            <div class="col-md-6 offset-md-3 text-center">
                <h3 class="font-32 font-bold mb-2 text-uppercase">Thank you! for the shoppping please visit again.</h3>
                <a href="{{ url('home') }}" class="outline_button font-bold font-18 py-3 text-uppercase d-block mt-5 mb-3">Continue Shopping</a>
                <a href="{{ url('my-orders') }}" class="outline_button font-bold font-18 py-3 text-uppercase d-block mt-5 mb-3">View Your Order</a>
